                            ...
                            <div class="carousel-item active">
                              ...
                              <div class="carousel-caption custom-first px-5 d-none d-md-block rounded-4">
                                ...
                                <h5 className="fw-normal">
                                  ...
                                  menyediakan fitur anotasi data manual maupun
                                  otomatis untuk mahasiswa dalam melakukan
                              ...
                              <div class="card empty" style={{ width: "80%" }}>
                                ...
                                >
                                  <h5 class="card-title text-center">
                                    Data Penelitian Selesai Kosong{" "}
                                  </h5>
