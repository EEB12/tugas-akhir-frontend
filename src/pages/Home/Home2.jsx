				...
				<div className="row ">
						...
						<div className="sidebar2 ">
							<div className="icon-container mt-4">
								...
								>
									...
									>
										<div>
											<img className="sub-filter me-2" src="/icons/ic-wa.png" onClick={(e) => handlechannel("Whatsapp")} alt="filter wa" />
										</div>
										<div>
											<img className="sub-filter me-2" src="/icons/ic-line.png" alt="filter wa" />
										</div>
										<div>
											<img className="sub-filter me-2" src="/icons/ic-tele.png" onClick={(e) => handlechannel("telegram")} alt="filter wa" />
										</div>
										<div>
											<img className="sub-filter" src="/icons/ic-globe.png" onClick={(e) => handlechannel("")} alt="filter wa" />
										</div>
									</div>
					...
					<div className="col-3 chatlist-area">
						<div className="profile-input-area">
							<img class="user-profile" src="/icons/user.svg" alt="user" onClick={() => handleShow()} />

							<input type="search" placeholder="Search" onChange={(e) => searchfilter(e)} />
						...
						<div className="chat-list-container2">
							...
							{contactlist?.map((value, index) =>
								...
								value.platform == "widget" ?
									...
									<div className="chatbox2" onClick={() => handleChat(value, value.socket_id, index, value.platform)}>
										<div className="user-image2 me-3">
											<div id="user-profilepicture">
												<h1 className="ms-3"   >{(value?.username[0])?.toUpperCase()}</h1>
											</div>

											{/* <img src={value.image} id="user-profilepicture" alt="user" /> */}
											<img className="ms-2" id="icon-platform" src="/icons/ic-globe.png" />
										</div>
									...
									: value.platform == "whatsapp" ?
										...
										<div className="chatbox2" onClick={() => handleChatWA(value.number, value.platform, index)}>
											<div className="user-image2 me-3">
												<img src={value.foto_profil} id="user-profilepicture" alt="user" />
										...
										:
										<div className="chatbox2" onClick={() => handleChattele(value.id, value.platform, index)} >
											<div className="user-image2 me-3">
												<div id="user-profilepicture">
													<h1 className="ms-3"   >{(value?.username[0])?.toUpperCase()}</h1>
												</div>
					...
					<div className="col px-0 chat-area	">
						<div className="kotak d-flex flex-column">
							...
							{chatplatform === "whatsapp" ?
								<TopbarWA contactlist={contactlist} truchatindex={truchatindex}></TopbarWA>

								// console.log(chatplatform)
								:
								<Topbar contactlist={contactlist} truchatindex={truchatindex}></Topbar>
								// console.log(chatplatform)
							}
...

							{
								chatplatform === "whatsapp"
									...
									<>
										...
										<ChatContentWA contact={contactlist[truchatindex]} contentChat={chatmessage} idAdmin={admin} socketinfo={sendmessage} index={chatindex} function={handleScroll}>
									...
									: chatplatform === "widget" ?
										...
										<><ChatContent contact={contactlist[truchatindex]} contentChat={chatmessage} idAdmin={admin} socketinfo={sendmessage} index={chatindex} function={handleScroll}></ChatContent></>
										:
										<><ChatContentTele contact={contactlist[truchatindex]} contentChat={chatmessage} function={handleScroll}></ChatContentTele></>
							...
							<div class="tes row g-0 mt-0 mb-0 ">
								...
								<div className="col ms-2 ">
									{chatplatform === "whatsapp" ?
										<input className="chat-input" value={message} type="search" placeholder="Search" onKeyDown={(e) => handleKeyDownWA(e)} onChange={(e) => messagehandler(e)} />
										: chatplatform === "telegram" ?

											<input className="chat-input" value={message} type="search" placeholder="Search" onKeyDown={(e) => handleKeyDownTele(e)} onChange={(e) => messagehandler(e)} />

											:
											<input className="chat-input" value={message} type="search" placeholder="Search" onKeyDown={(e) => handleKeyDown(e)} onChange={(e) => messagehandler(e)} />
									}
								...
								<div className="col-auto align-self-center me-5 send-message" onClick={() => submitmessage()}>
					...
					<div class="col-sm-2 col-auto px-0 collapse collapse-horizontal overflow-hidden profil-kanan" id="sidebar">
						<div class="list-group border-0 text-center text-sm-start min-vh-100 align-items-center" id="sidebar-menu">
