                                                                        ...
                                                                        <div className='container-fluid'>
                                                                            <div className='row'>
                                                                                ...
                                                                                <div className='col-6 d-flex justify-content-end mt-4'>
                                                                                    ...
                                                                                    <button  type="button" class="  interactive-button "><Box sx={{ color: '#FFFFFF', fontWeight: 600, fontSize: 16, paddingLeft: 2, paddingRight: 2 }}>Download .pickle</Box></button>
                                                                                    ...
                                                                                    <button href={`#`} type="button" class=" interactive-button detail ms-4"><Box sx={{ color: '#FFFFFF', fontWeight: 600, fontSize: 16 }}><a className='detail' href={`/detail-penelitian/` + item.id_anotasi}>Edit</a> </Box></button>
