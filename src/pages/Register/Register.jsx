      ...
      <ThemeProvider theme={defaultTheme}>
        <Grid container component="main" sx={{ height: "100vh" }}>
          ...
          >
            ...
            >
              <img src="./Logo-its.png"></img>
              <Typography color="common.white" component="h1" variant="h5">
                <Box sx={{ fontWeight: 500, m: 1, fontSize: 40 }}>
                  Selamat Datang
                </Box>
              </Typography>
              ...
              <Typography color="common.white" variant="subtitle1" gutterBottom>
                ...
                >
                  {" "}
                  Silahkan melakukan login setelah melakukan registrasi
                </Box>
              </Typography>
              ...
              >
                <Box
                  color="common.white"
                  sx={{ textAlign: "center", fontWeight: 400, m: 1 }}
                >
                  Log in
                </Box>
              </Button>
          ...
          >
            ...
            >
              <Typography color="#02A9F1" component="h1" variant="h5">
                <Box sx={{ fontWeight: 1000, m: 1, fontSize: 48 }}>
                  Create Account
                </Box>
              </Typography>
